...
/** The berceuse is 25 MB of fixtures — too large to commit, run from MLign. */
const MLIGN_GOLDEN = join(__dirname, '..', '..', 'MLign', 'test', 'golden')
...
function findFixture(slug: string): string | null {
  for (const root of [LOCAL_GOLDEN, MLIGN_GOLDEN]) {
